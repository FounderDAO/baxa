    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.IntegerField(choices=[(1, 'Uzbek'), (2, 'Russian'), (3, 'English'), (4, 'Turkey')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_number', models.CharField(blank=True, max_length=25, null=True)),
                ('first_name', models.CharField(blank=True, max_length=100, null=True)),
                ('last_name', models.CharField(blank=True, max_length=100, null=True)),
                ('midd_name', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('type', models.IntegerField(choices=[(1, 'Author'), (2, 'Owner'), (3, 'Guest')], default=3)),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.country')),
                ('district', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.district')),
